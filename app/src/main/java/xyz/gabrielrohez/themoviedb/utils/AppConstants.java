...
public class AppConstants {
    public static final String API_KEY_YOUTUBE          =           "AIzaSyAokFpTR8g3PbbpnO1Ddew1UF95CU2dYW4";
    public static final String BASE_GET_URL_VIDEO       =           "http://api.themoviedb.org/3/movie/";
    public static final String BASE_YOUTUBE_URL         =           "https://www.youtube.com/watch?v=";
    public static final String API_KEY                  =           "9e110818a5022b054903d31603bfe453";
    ...
    public static final String NAME_DATABASE            =           "tmdb_database";
    public static final String TAG_POPULAR              =           "TAG_POPULAR";
    public static final String TAG_COMING               =           "TAG_COMING";
